...
import { joinMatch, getUserMatches, getAllUserUpcomingMatches, getMatchSpots, forceLeaveMatch, leaveMatch } from '../controller/booking';
...
router.delete('/leave/:matchId', auth, leaveMatch);
